<template>
	<div class="intro screen">
		<div class="nomargin inner">
			<div class='nomargin logo img' style="background-image:url(./assets/logo.png);"></div>
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide">

						<div class='img' style="background-image:url(./assets/welcome-1.png);"></div>
					...
					<div class="swiper-slide">
						...
						<div class='img' style="background-image:url(/assets/welcome-2.png);"></div>
					...
					<div class="swiper-slide">
						...
						<div class='img' style="background-image:url(/assets/welcome-3.png);"></div>
